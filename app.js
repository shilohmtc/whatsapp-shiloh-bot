...
const { runP2StaffRolloutSmokeTest } = require("./src/services/p2StaffRolloutSmokeTest");
...
async function start(){
 ...
 if(process.env.RUN_P2_STAFF_ROLLOUT_SMOKE_TEST==="true"){await runP2StaffRolloutSmokeTest();}
