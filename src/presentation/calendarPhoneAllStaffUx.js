...
function phoneAllStaffStyles() {
  return `@media(max-width:700px){.phone-week-all-staff-toggle{font-weight:900}.phone-week-all-staff-toggle.active{border-color:var(--leaf-deep);background:var(--leaf-deep);color:#fff}body[data-phone-all-staff="true"] .workspace-main .week-view .positioned-event .event-card{padding-left:3px!important;padding-right:3px!important}body[data-phone-all-staff="true"] .workspace-main .week-view .positioned-event .event-practitioners{display:inline-flex!important}body[data-phone-all-staff="true"] .workspace-main .week-view .positioned-event .event-practitioner-full{display:none!important}body[data-phone-all-staff="true"] .workspace-main .week-view .positioned-event .event-practitioner-compact{display:inline!important}}`;
}
