...
let revalidating=false,lastRevalidation=0,reloadingForUpdate=false;
...
addEventListener('pageshow',()=>{installGuidance();lastRevalidation=0;revalidate();});
document.addEventListener('visibilitychange',()=>{if(document.visibilityState==='visible'){installGuidance();revalidate();}});
register();revalidate();
})();`;
}
