...
addEventListener('beforeinstallprompt',event=>{if(standalone()||iosDevice())return;event.preventDefault();deferredInstallPrompt=event;removeInstallCard('[data-shiloh-browser-install]');installAction();});
