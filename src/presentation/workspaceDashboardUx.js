...
function renderDashboardPage(model, { staffAccessScriptPath = '/calendar/staff/client.js', dashboardScriptPath = '/calendar/workspace/client.js', navigation = {} } = {}) {
  ...
  const attention = requestCards || finalizationSummary || finalizationQueue ? `${requestCards}${finalizationSummary}${finalizationQueue}` : '<div class="empty">No booking request or past visit currently needs staff action.</div>';
  const carryOver = model.carryOver || [];
