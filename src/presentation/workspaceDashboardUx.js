...
function appointmentItem(item, model, { manageLabel = 'Open / manage', idPrefix = 'dashboard-appointment' } = {}) {
...
function renderDashboardPage(model, { staffAccessScriptPath = '/calendar/staff/client.js', dashboardScriptPath = '/calendar/workspace/client.js', navigation = {} } = {}) {
  ...
  const finalizationCards = awaitingFinalization.map(item => appointmentItem(item, model, { manageLabel: 'Review visit', idPrefix: 'dashboard-attention-appointment' })).join('');
