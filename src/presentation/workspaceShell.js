...
function workspaceItem({ label, active, href }) {
  ...
  return `<span class="workspace-link future" aria-disabled="true">${escapeHtml(label)}</span>`;
}
...
function renderWorkspaceNavigation({
  ...
  return `<aside class="workspace-nav"><div class="workspace-mark">Shiloh <small>Workspace</small></div><nav class="workspace-links" aria-label="Workspace">${[
    ...
    workspaceItem({ label: 'Staff', active: false, href: null }),
