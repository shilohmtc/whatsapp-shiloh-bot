...
@media(max-width:850px){.hero-grid{grid-template-columns:1fr}.hero-card{min-height:250px}.grid,.fact-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.contact-panel{grid-template-columns:1fr}.nav a:not(.book){display:none}}
