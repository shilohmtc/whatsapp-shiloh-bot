...
async function rescheduleCanonical(phone,a,date,time){
 if(a?.crm_v2_client_id!=null)return{status:'crm_v2_reschedule_approval_required',reply:CRM_V2_LEGACY_ONLY_BOUNDARY_REPLY};
