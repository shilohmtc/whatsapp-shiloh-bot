...
test('complete registry contains all 20 exact expected/current/legacy identities',()=>{
 assert.equal(CONTRACTS.length,20); assert.equal(new Set(CONTRACTS.map(x=>x.contract.name)).size,20);
