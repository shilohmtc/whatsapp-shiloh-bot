...
test('complete registry contains all 19 exact expected/current/legacy identities',()=>{
 assert.equal(CONTRACTS.length,19); assert.equal(new Set(CONTRACTS.map(x=>x.contract.name)).size,19);
