...
test('migration 107 grants only the explicitly owner-authorized canonical operator set', () => {
  assert.match(sql, /id IN \(1, 2, 4\)/);
  assert.doesNotMatch(sql, /id IN \(1, 2, 4, 5\)/);
