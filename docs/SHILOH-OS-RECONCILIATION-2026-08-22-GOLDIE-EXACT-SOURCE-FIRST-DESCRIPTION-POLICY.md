...
JP explicitly authorizes an **exact-source-first** policy for Goldie service descriptions.
...
4. **Where adequate retained support exists, preserve the exact wording.** The exact source remains preferred unless JP later approves a different client-facing formulation.
...
- D5, D8 and D11 no longer impose automatic neutralization or whole-description withholding merely because treatment/clinical claims exist.
- Instead, exact source wording is the default and any objectively testable claim is reviewed at the **specific-claim level**. Supported claims may remain verbatim; unsupported/disputed claims return for an explicit business decision.
