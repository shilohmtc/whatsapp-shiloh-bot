...
Production runtime baseline: PR #195 squash merge `7a9886a592791b1bb5cfcb8f8366297abd9c1dd6`; Render deploy `dep-d9vcrv8ae00c73fuecv0` reached live. Documentation-only descendants may advance exact `main`/Render head without changing runtime behavior.

Pre-booking routing repairs are now accepted:
...
- **Real WhatsApp now proves the exact phrase enters the CRM-backed Lymphatic treatment list.** Observed rows: `Facial Lymphatic Drainage Massage` • 60 min • R450 and `Lymphatic Drainage Reset Package` • 90 min • R500. C1-FAMILY-NL is closed; do not repeat solely for proof.
