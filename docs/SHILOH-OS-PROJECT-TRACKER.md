...
| B1 | Remaining Admin route acceptance | ⚪ READY | Finish genuinely unverified role-specific WhatsApp paths only; shared no-slot recovery is already implemented. |
